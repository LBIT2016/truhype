...
class PostVideoEditable extends React.Component {
	state = {
			...
			<div>
			  <Segment.Group raised style={{ margin: "15px", marginBottom: "10px" }}>
			  	...
			  	<Segment textAlign="center" style={{ padding: "0px" }}>
					<VideoUploader 
						getVideosUrls={this.props.getVideosUrls}
					/>
			  	</Segment>
			  ...
			  <Container textAlign="right">
				  <Button 
				  	secondary 
				  	content="Publish" 
				  	onClick={this.props.onVideoPostSubmit} 
				  />
			  </Container>
		  </div>
		);
...
PostVideoEditable.propTypes = {
	...
	onVideoPostSubmit : PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getlocation })(PostVideoEditable);