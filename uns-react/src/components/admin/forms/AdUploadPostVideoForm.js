...
class AdUploadPostVideoForm extends Component {
	state = {
		whichPage: "VideoUploader",
		data: {
			country: "",
			state: "",
			city: ""
	...
	render() {
		...
		return (
			<div>
				...
				{ whichPage === "EditForm" && (
					<div>
						{/* <Button size="small" color="grey" onClick={this.handlePageChange} value="VideoUploader">
							...
							<Grid.Row columns={2}>
								...
								<Grid.Column>
									<Container fluid align="right">
										<Button onClick={this.props.onVideoPostSubmit} color="grey" content="Submit" />
									</Container>
								</Grid.Column>
							</Grid.Row>
						</Grid>
